...
class HomeCareVIC extends StatefulWidget {
  const HomeCareVIC({super.key});

  @override
  State<HomeCareVIC> createState() => _PartiVicState();
}

class _PartiVicState extends State<HomeCareVIC> {
