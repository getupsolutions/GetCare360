...
class HomecareStaffNSW extends StatefulWidget {
  const HomecareStaffNSW({super.key});

  @override
  State<HomecareStaffNSW> createState() => _StaffVictoriaPageState();
}

class _StaffVictoriaPageState extends State<HomecareStaffNSW> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: 'Staff- NSW', centerTitle: true),
