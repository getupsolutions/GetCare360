...
class HomecareAddNewStaffTypePage extends StatefulWidget {
  const HomecareAddNewStaffTypePage({super.key});

  @override
  State<HomecareAddNewStaffTypePage> createState() => AddNewStaffTypePageState();
}

class AddNewStaffTypePageState extends State<HomecareAddNewStaffTypePage> {
