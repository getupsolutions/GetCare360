...
class NdisAddNewStaffTypePage extends StatefulWidget {
  const NdisAddNewStaffTypePage({super.key});

  @override
  State<NdisAddNewStaffTypePage> createState() => NdisAddNewStaffTypePageState();
}

class NdisAddNewStaffTypePageState extends State<NdisAddNewStaffTypePage> {
