...
class AdminAllChart extends StatefulWidget {
  const AdminAllChart({super.key});

  @override
  State<AdminAllChart> createState() => _AllChartState();
}

class _AllChartState extends State<AdminAllChart> {
