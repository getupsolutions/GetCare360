...
class AdminVIC extends StatefulWidget {
  const AdminVIC({super.key});

  @override
  State<AdminVIC> createState() => _PartiVicState();
}

class _PartiVicState extends State<AdminVIC> {
  ...
  final List<ParticipantItem> _all = [
    ...
    ParticipantItem(
      ...
      state: "New South Wales",
      phone: "0404647349",
      email: "megan@trustedAdmin.com.au",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'Victoria', centerTitle: true),
      body: SafeArea(
        child: Padding(
