...
class AdminRosterPage extends StatefulWidget {
  const AdminRosterPage({super.key});

  static const pageBg = Color(0xFFF3F4F8);
  static const purple = Color(0xFF8E24AA);
  @override
  State<AdminRosterPage> createState() => _AdminRosterPageState();
}

class _AdminRosterPageState extends State<AdminRosterPage> {
  @override
...
class RosterHeaderCardState extends State<RosterHeaderCard> {
  ...
  @override
  Widget build(BuildContext context) {
    const purple = AdminRosterPage.purple;
