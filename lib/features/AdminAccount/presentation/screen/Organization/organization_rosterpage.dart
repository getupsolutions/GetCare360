...
/// ------------------------------------------------------------
/// Organization Roster Page (Responsive + Optimized UI)
/// Matches the screenshot layout:
/// - Purple header card with filters + actions
/// - Weekly columns grid with shift cards
/// - Horizontal scroll for grid on smaller widths
/// - Mobile fallback: still scrollable & readable
/// ------------------------------------------------------------
class AdminOrganizationRosterPage extends StatelessWidget {
  const AdminOrganizationRosterPage({super.key});
...
class RosterHeaderCardState extends State<RosterHeaderCard> {
  ...
  @override
  Widget build(BuildContext context) {
    const purple = AdminOrganizationRosterPage.purple;
