...
class AddNewStaffGroupPage extends StatefulWidget {
  const AddNewStaffGroupPage({super.key});

  @override
  State<AddNewStaffGroupPage> createState() => AddNewStaffGroupPageState();
}

class AddNewStaffGroupPageState extends State<AddNewStaffGroupPage> {
