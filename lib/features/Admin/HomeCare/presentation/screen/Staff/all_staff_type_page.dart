...
import 'package:getcare360/features/Admin/Ndis/presentation/screen/Staff/ndis_add_new_stafftype_page.dart' hide FooterBar, StaffTypeItem;

class HomecareAllStaffTypePage extends StatefulWidget {
  const HomecareAllStaffTypePage({super.key});

  @override
  State<HomecareAllStaffTypePage> createState() => AllStaffTypePageState();
}

class AllStaffTypePageState extends State<HomecareAllStaffTypePage> {
