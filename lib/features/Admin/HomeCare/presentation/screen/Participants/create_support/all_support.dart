...
class HomecareAllSupport extends StatefulWidget {
  const HomecareAllSupport({super.key});

  @override
  State<HomecareAllSupport> createState() => _AllSupportState();
}

class _AllSupportState extends State<HomecareAllSupport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "Support", centerTitle: true),
      body: SafeArea(
        child: Padding(
