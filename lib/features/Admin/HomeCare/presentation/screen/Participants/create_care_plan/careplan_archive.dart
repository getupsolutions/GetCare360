...
class HomecareCareplanArchive extends StatefulWidget {
  const HomecareCareplanArchive({super.key});

  @override
  State<HomecareCareplanArchive> createState() => _CareplanArchiveState();
}

class _CareplanArchiveState extends State<HomecareCareplanArchive> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "Care Plans", centerTitle: true),
      body: SafeArea(
        child: Padding(
