...
class HomecareAddNewCarePlanPage extends StatefulWidget {
  const HomecareAddNewCarePlanPage({super.key});

  @override
  State<HomecareAddNewCarePlanPage> createState() => _AddNewCarePlanPageState();
}

class _AddNewCarePlanPageState extends State<HomecareAddNewCarePlanPage> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _TextField(ctrl: _titleCtrl, hint: "Title"),
                      const SizedBox(height: 16),

                      _Label("Questions"),
                      const SizedBox(height: 6),
                      _TextField(ctrl: _questionCtrl, hint: "", minLines: 1),
                      ...
                      _SectionTable(
                        ...
                        onDelete: (i) => _removeItem(observations, i),
                      ),
                      ...
                      _SectionTable(
                        ...
                        items: goals,
                        onAdd: () =>
                            _addItemDialog(sectionName: "Goals", list: goals),
                        onDelete: (i) => _removeItem(goals, i),
                      ),
                      ...
                      _SectionTable(
                        ...
                        items: interventions,
                        onAdd: () => _addItemDialog(
                          sectionName: "Interventions",
                          list: interventions,
                        ),
                        onDelete: (i) => _removeItem(interventions, i),
                      ),
