...
/// ------------------------------------------------------------
class AdminOrganizationTimesheetPage extends StatefulWidget {
  const AdminOrganizationTimesheetPage({super.key});

  static const pageBg = Color(0xFFF3F4F8);
  static const purple = Color(0xFF8E24AA);

  @override
  State<AdminOrganizationTimesheetPage> createState() =>
      _OrganizationTimesheetPageState();
}

class _OrganizationTimesheetPageState extends State<AdminOrganizationTimesheetPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: AdminOrganizationTimesheetPage.pageBg,
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, c) {
            final w = c.maxWidth;
...
class TimesheetHeaderCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const purple = AdminOrganizationTimesheetPage.purple;
