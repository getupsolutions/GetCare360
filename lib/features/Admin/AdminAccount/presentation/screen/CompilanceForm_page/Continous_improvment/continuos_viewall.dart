...
class AdminContinuosViewAllPage extends StatefulWidget {
  ...
  const AdminContinuosViewAllPage({
    super.key,
    this.onAddNew,
    this.onView,
    this.onEdit,
  ...
  @override
  State<AdminContinuosViewAllPage> createState() =>
      AdminContinuosViewAllPageState();
}

class AdminContinuosViewAllPageState extends State<AdminContinuosViewAllPage> {
