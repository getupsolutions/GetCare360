...
class ComplianceIncidentViewAllPage extends StatefulWidget {
  ...
  const ComplianceIncidentViewAllPage({
    super.key,
    this.onAddNew,
    this.onView,
    this.onEdit,
  ...
  @override
  State<ComplianceIncidentViewAllPage> createState() =>
      _ComplianceIncidentViewAllPageState();
}

class _ComplianceIncidentViewAllPageState
    extends State<ComplianceIncidentViewAllPage> {
