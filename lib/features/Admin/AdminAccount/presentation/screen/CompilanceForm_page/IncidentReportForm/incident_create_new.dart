...
class CreateComplianceIncidentPage extends StatefulWidget {
  final VoidCallback? onSave;
  final VoidCallback? onContinue;

  const CreateComplianceIncidentPage({super.key, this.onSave, this.onContinue});

  @override
  State<CreateComplianceIncidentPage> createState() =>
      _CreateComplianceIncidentPageState();
}

class _CreateComplianceIncidentPageState
    extends State<CreateComplianceIncidentPage> {
