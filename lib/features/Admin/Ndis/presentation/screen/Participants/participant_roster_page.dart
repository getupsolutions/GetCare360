...
class ParticipantRosterPage extends StatefulWidget {
  const ParticipantRosterPage({super.key});

  static const pageBg = Color(0xFFF3F4F8);
  static const purple = Color(0xFF8E24AA);
  @override
  State<ParticipantRosterPage> createState() => _ParticipantRosterPageState();
}

class _ParticipantRosterPageState extends State<ParticipantRosterPage> {
  @override
...
class RosterHeaderCardState extends State<RosterHeaderCard> {
  ...
  @override
  Widget build(BuildContext context) {
    const purple = ParticipantRosterPage.purple;
