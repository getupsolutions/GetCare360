...
class AddNewStaffTypePage extends StatefulWidget {
  const AddNewStaffTypePage({super.key});

  @override
  State<AddNewStaffTypePage> createState() => AddNewStaffTypePageState();
}

class AddNewStaffTypePageState extends State<AddNewStaffTypePage> {
